...
uid       [ultimate] Rui Afonso Pereira <rpereira@users.noreply.github.com>
...
address we have. You can easily edit your key to add another user id:
    ...
    ➔ gpg --edit-key rpereira@users.noreply.github.com
    ...
    [ultimate] (1)  Rui Afonso Pereira <rpereira@users.noreply.github.com>
...
user ID, type `adduid`.
    ...
    user: "Rui Afonso Pereira <rpereira@users.noreply.github.com>"
    ...
    [ultimate] (2)  Rui Afonso Pereira <rpereira@users.noreply.github.com>
...
you for a change. You can verify signatures using `git log`:
    ...
    gpg:                 aka "Rui Afonso Pereira <rpereira@users.noreply.github.com>" [ultimate]
    Author: Rui Afonso Pereira <rpereira@users.noreply.github.com>
